...
exports.Simulator = exports.Process = exports.Message = exports.Random = void 0;
exports.unicast = unicast;
exports.anycast = anycast;
class Random {
...
function unicast(iaddr) {
    return { kind: "unicast", iaddr };
}
function anycast(gaddr, iaddr) {
...
class Message {
    ...
    data;
    head;
    constructor(source, target, data, head = {}) {
        this.source = source;
        this.target = target;
        this.data = data;
        this.head = head;
...
class Process {
    ...
    log(tick, ...args) {
        const message = `[tick: ${tick}] [proc: ${this.iaddr}] ${args.map(JSON.stringify)}`;
...
class Simulator {
    ...
    scheduledRepeat = [];
    scheduledDelay = [];
    constructor(prng, { dropProb = 0, randomDelay = 0, duplProb = 0, deactivateProb = 0, activateProb = 0 } = {}) {
