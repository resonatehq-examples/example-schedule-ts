...
const worker1 = new worker_1.WorkerProcess(rnd, clock, encoder, registry, { charFlipProb: options.charFlipProb }, "worker-1", "default");
const worker2 = new worker_1.WorkerProcess(rnd, clock, encoder, registry, { charFlipProb: options.charFlipProb }, "worker-2", "default");
const worker3 = new worker_1.WorkerProcess(rnd, clock, encoder, registry, { charFlipProb: options.charFlipProb }, "worker-3", "default");
...
sim.delay(0, () => {
    sim.send(new simulator_1.Message((0, simulator_1.unicast)("environment"), (0, simulator_1.unicast)("server"), {
        kind: "createPromise",
        id,
        timeout: 10000000,
        iKey: id,
