...
export type Request = CreatePromiseReq | CreatePromiseAndTaskReq | ReadPromiseReq | CompletePromiseReq | CreateCallbackReq | CreateSubscriptionReq | CreateScheduleReq | ReadScheduleReq | DeleteScheduleReq | ClaimTaskReq | CompleteTaskReq | DropTaskReq | HeartbeatTasksReq | SearchPromisesReq | SearchSchedulesReq;
...
export type Response = CreatePromiseRes | CreatePromiseAndTaskRes | ReadPromiseRes | CompletePromiseRes | CreateCallbackRes | CreateSubscriptionRes | CreateScheduleRes | ReadScheduleRes | DeleteScheduleRes | ClaimTaskRes | CompleteTaskRes | DropTaskRes | HeartbeatTasksRes | SearchPromisesRes | SearchSchedulesRes;
...
export type ResponseFor<T extends Request> = Extract<Response, {
    kind: T["kind"];
}>;
